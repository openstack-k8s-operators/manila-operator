...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.0.0-20230714104628-12cc1e43cccd // indirect; indirect // indirect // indirect // indirect // indirect

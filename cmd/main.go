...
// Package main is the entry point for the manila-operator.
package main
...
import (
	...
	"github.com/openstack-k8s-operators/manila-operator/internal/controller"
	webhookv1beta1 "github.com/openstack-k8s-operators/manila-operator/internal/webhook/v1beta1"
...
func main() {
	...
	if err := (&controller.ManilaAPIReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(context.Background(), mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ManilaAPI")
		os.Exit(1)
	}
	...
	if err := (&controller.ManilaSchedulerReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(context.Background(), mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ManilaScheduler")
		os.Exit(1)
	}
	if err := (&controller.ManilaShareReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(context.Background(), mgr); err != nil {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1beta1.SetupManilaWebhookWithManager(mgr); err != nil {
